...
const fileItem = tv({
  slots: {
    ...
    icon: 
      'rounded-full border-4 border-teal-100 bg-teal-200 text-teal-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      complete: {
        container: 'border-teal-500 dark:border-teal-300/30'
      },
      error: {
           ...
           <UploadCloud className="h-4 w-4"/>
            ...
            {state === 'error' ? (
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium font-zinc-700 text-error-700 dark:text-error-400">Upload failed, please try again.</span>
                ...
                <div className="flex flex-1 flex-col items-start gap-1">
                <div className="flex flex-col">
                  <span className="text-sm font-medium font-zinc-700 dark:text-zinc-100">{name}</span>
                ...
                <div className="flex w-full items-center gap-3">
                  <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
                    <div className="h-2 rounded-full bg-teal-600 dark:bg-teal-400" style={{ width: state === 'complete' ? '100%' : '80%' }}/>
